...
def Load_ind_data(path):
    ...
    Data.columns = Data.columns.str.strip() #Enleve l'espace dans le titre des colonnes
...
def Load_rf(path, date = '2022-08-01'):
    ...
    # convert the annual riskfree rate to rate monthly
...
# Determination of the expected return (Fonction for the resambling approah)  : 
...
#################### Approach without resampling  #################### :

####### Contexte without risk-free asset ####### :
...
# Determination of the global minimum variance portfolio :
